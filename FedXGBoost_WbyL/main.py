...
from model.xgboost_WbyL import GradientBoostingMultiClassifier
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Federated_XGBoost_WbyL')
    parser.add_argument('--seed', default=0, type=int, help='랜덤 시드 설정')
    parser.add_argument('--filename', default="nursery", type=str, help='데이터 파일명')
    ...
    parser.add_argument('--env', default='label_nonIID', type=str, help='클라이언트 데이터 환경 설정',
                        choices=['IID', 'label_nonIID'])
